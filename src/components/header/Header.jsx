...
const Header = () => {
    ...
    window.addEventListener("scroll",function(){
        ...
        // when the scroll is higher that 200 viewport height, add the scroll-header to a tag with the header tag
  ...
  return (
    ...
    <header className="header">
        <nav className="nav container">
            ...
            <div className="nav__toggles" onClick={()=> showMenu(!Toggle)}>
